...
def find_ranking(all_members_rsvpd_events):
    rsvp_events = all_members_rsvpd_events['12563492']
    ...
    Yarr = []
    for event_id in dictionary["location_classifier"]["12563492"]:
        if event_id in rsvp_events:
            Yarr.append(1)
        else:
            Yarr.append(0)
    ...
    np.random.seed(1)
    n_samples, n_features = len(dictionary["location_classifier"]["12563492"]), 4
